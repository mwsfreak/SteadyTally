...
PROGMEM const char html0[] = "";
PROGMEM const char html1[] = "<html><title>ATEM Tally Transmitter Setup</title></html>";
PROGMEM const char html2[] = "<table bgcolor=\"#999999\" border";
PROGMEM const char html3[] = "=\"0\" width=\"100%\" cellpadding=\"1\" style=\"font-family:Verdana;color:#fff";
PROGMEM const char html4[] = "fff;font-size:12px;\"><tr><td>&nbsp ATEM Tally Transmitter Setup</td></tr></table><br>";

PROGMEM const char html5[] = "<script>function hex2num (s_hex) {eval(\"var n_num=0X\" + s_hex);return n_num;}";
PROGMEM const char html6[] = "</script><table><form><input type=\"hidden\" name=\"SBM\" value=\"1\"><tr><td>MAC:</td>";
PROGMEM const char html7[] = "<td><input id=\"T1\" type=\"text\" size=\"2\" maxlength=\"2\" name=\"DT1\" value=\"";
PROGMEM const char html8[] = "\">.<input id=\"T3\" type=\"text\" size=\"2\" maxlength=\"2\" name=\"DT2\" value=\"";
PROGMEM const char html9[] = "\">.<input id=\"T5\" type=\"text\" size=\"2\" maxlength=\"2\" name=\"DT3\" value=\"";
PROGMEM const char html10[] = "\">.<input id=\"T7\" type=\"text\" size=\"2\" maxlength=\"2\" name=\"DT4\" value=\"";
PROGMEM const char html11[] = "\">.<input id=\"T9\" type=\"text\" size=\"2\" maxlength=\"2\" name=\"DT5\" value=\"";
PROGMEM const char html12[] = "\">.<input id=\"T11\" type=\"text\" size=\"2\" maxlength=\"2\" name=\"DT6\" value=\"";

PROGMEM const char html13[] = "\"><input id=\"T2\" type=\"hidden\" name=\"DT1\"><input id=\"T4\" type=\"hidden\" name=\"DT2";
PROGMEM const char html14[] = "\"><input id=\"T6\" type=\"hidden\" name=\"DT3\"><input id=\"T8\" type=\"hidden\" name=\"DT4";
PROGMEM const char html15[] = "\"><input id=\"T10\" type=\"hidden\" name=\"DT5\"><input id=\"T12\" type=\"hidden\" name=\"D";
PROGMEM const char html16[] = "T6\"></td></tr><tr><td>IP:</td><td><input type=\"text\" size=\"3\" maxlength=\"3\" name=\"DT7\" value=\"";
PROGMEM const char html17[] = "\">.<input type=\"text\" size=\"3\" maxlength=\"3\" name=\"DT8\" value=\"";
PROGMEM const char html18[] = "\">.<input type=\"text\" size=\"3\" maxlength=\"3\" name=\"DT9\" value=\"";
PROGMEM const char html19[] = "\">.<input type=\"text\" size=\"3\" maxlength=\"3\" name=\"DT10\" value=\"";

PROGMEM const char html20[] = "\"></td></tr><tr><td>ATEM SWITCHER:</td><td><input type=\"text\" size=\"3\" maxlength=\"3\" name=\"DT11\" value=\"";
PROGMEM const char html21[] = "\">.<input type=\"text\" size=\"3\" maxlength=\"3\" name=\"DT12\" value=\"";
PROGMEM const char html22[] = "\">.<input type=\"text\" size=\"3\" maxlength=\"3\" name=\"DT13\" value=\"";
PROGMEM const char html23[] = "\">.<input type=\"text\" size=\"3\" maxlength=\"3\" name=\"DT14\" value=\"";
PROGMEM const char html24[] = "\"> PORT<input type=\"text\" size=\"6\" maxlength=\"6\" name=\"DT15\" value=\"";
PROGMEM const char html25[] = "\"></td></tr><tr><td><br></td></tr><tr><td><input id=\"button1\"type=\"submit\" name=\"submit\" value=\"SUBMIT\" ";

PROGMEM const char html26[] = "Onclick=\"document.getElementById('T2').value ";
PROGMEM const char html27[] = "= hex2num(document.getElementById('T1').value);";
PROGMEM const char html28[] = "document.getElementById('T4').value = hex2num(document.getElementById('T3').value);";
PROGMEM const char html29[] = "document.getElementById('T6').value = hex2num(document.getElementById('T5').value);";
PROGMEM const char html30[] = "document.getElementById('T8').value = hex2num(document.getElementById('T7').value);";
PROGMEM const char html31[] = "document.getElementById('T10').value = hex2num(document.getElementById('T9').value);";
PROGMEM const char html32[] = "document.getElementById('T12').value = hex2num(document.getElementById('T11').value);\"";
PROGMEM const char html33[] = "></td></tr></form></table>";
PROGMEM const char html34[] = "<br>Restarting...";
